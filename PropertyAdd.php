...
if (isset($_POST['submit']) && isset($_FILES["property_image"]) && isset($_FILES["electricity_image"])) {
    ...
    // Move uploaded image files to the specified directory
    ...
    echo "Error: Form not submitted or missing files.";
}
?>
...
<form method="POST" enctype="multipart/form-data">
    ...
    <div class="column">
        ...
        <input type="number" id="maintenance-charges" name="maintenancecharges" placeholder="Enter the maintenance charges per month in INR" required>
        <br><br>

        <label for="built-up-area">Built-up Area (sq. ft.):</label>
        <input type="number" id="built-up-area" name="built" placeholder="Enter the built-up area in sq. ft." required>
        <br><br>
