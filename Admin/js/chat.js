...
function sendMessage() {
    ...
    $.post('your_php_script.php', { incoming_id: incoming_id, outgoing_id: outgoing_id, message: message }, function (data) {
        console.log(data);
        // Handle the response if needed
    });

    // You can update the UI here without waiting for the server response
    var messageElement = '<div class="message outgoing-message">You: ' + message + '</div>';
